...
\begin{itemize}
    ...
    \item \textbf{Evaluation Runtime and Throughput} on the development/test set reported by the Hugging Face \texttt{Trainer} (\texttt{eval\_runtime}, \texttt{eval\_samples\_per\_second}, \texttt{eval\_steps\_per\_second}) as a proxy for inference efficiency under the evaluation pipeline.
\end{itemize}
